...
function TaskPlayer({ task, taskIndex, totalTasks, onComplete, isLast, playSound }: TaskPlayerProps) {
  ...
  return (
    <div className="flex flex-col md:flex-row gap-6 md:gap-8">
      ...
      <div className="md:w-2/5 lg:w-2/5 order-2 md:order-1">
        <Card className="h-full">
          <CardContent className="pt-6 space-y-4">
            ...
            {/* Task Prompt */}
            <div className="bg-chessio-surface-dark border border-chessio-border-dark rounded-lg p-4">
              <p className="text-sm text-chessio-muted-dark mb-1">Your task</p>
              <p className="font-medium text-chessio-text-dark tracking-tight">
                {task.prompt}
              </p>
            </div>
            ...
            <div className="min-h-[48px] flex items-center">
              {feedback === "correct" && (
                <p className="text-sm text-chessio-primary flex items-center gap-2 font-medium">
            ...
            {/* Hint Section */}
            <div className="pt-2 border-t border-chessio-border-dark">
              {showHint ? (
                <p className="text-sm text-chessio-muted-dark italic">
                  💡 {hintMessage}
                </p>
              ) : (
      ...
      <div className="md:w-3/5 lg:w-3/5 flex justify-center order-1 md:order-2">
        <div className="lesson-board-container w-full max-w-[min(500px,100%)] lg:max-w-[min(550px,100%)]">
          <Chessboard
            fen={fen}
